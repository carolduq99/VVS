 ...
 */
public class CelsiusAbstractUiTest extends AssertJSwingTestCaseTemplate {
    ...
    public final void setUp() {
        ...
        CelsiusConverter mainWindow = GuiActionRunner.execute(new GuiQuery<CelsiusConverter>() {

            @Override
            protected CelsiusConverter executeInEDT() throws Exception {
                return CelsiusConverter.showWindow();
            }
        });
